...
odd.tr.london
#odds ratio
odd.tr.london/odd.dens.london # Esempio: ho 3 volte piu' prob di essere collegato ad un nodo se we share a common friend
...
assortativity(london.net, V(london.net)$Birthplace) 
...
assortativity(london.net, V(london.net)$Age)
